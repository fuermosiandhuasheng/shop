<template>
  <div>
    ...
    <!-- 卡片视图 -->
        ...
        <!-- 搜索与添加区域 -->
         <el-row :gutter="20">
           <el-col :span="7">
              <el-input placeholder="请输入内容" v-model="queryInfo.query">
                <el-button slot="append" icon="el-icon-search" @clear="getUserList" clearable @click="getUserList"></el-button>
              </el-input>
           </el-col>
           <el-col :span="4">
         ...
         <el-table :data="userlist" border stripe>
           ...
           <el-table-column label="状态">
             <!-- 通过作用域插槽接收scope 就可以通过scope.row来显示所有数据 -->
      ...
      :page-sizes="[1, 2, 5, 10]" :page-size="queryInfo.pagesize" layout="total, sizes, prev, pager, next, jumper" :total="totle">
          </el-pagination>
      </el-card>
      <!-- 添加用户的对话框 -->
      <el-dialog
...
export default {
  ...
  methods: {
    ...
    async removeUserById(id) {
      // 用户确认删除则返回字符串confirm 取消则是字符串cancel
